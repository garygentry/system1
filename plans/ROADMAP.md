...
| **M8** | **Onboarding: the first hour works** | **next.** A cookbook of tested question sets; `docs/`; a first-run and error-message pass; macOS verified and a CI matrix; the supported-model statement |
