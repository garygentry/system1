...
```json
{
  ...
  "projection": {
    "basis": "projected",
    "calls": 4,
    "estimatedInputTokens": 2144,
    "projectedUsd": 9.0048e-05,
...
{"v":1,"status":"summary","spec":"no-timeout","model":"typesafe/jev-1.13","skipped":{"total":0,"byReason":{},"sample":[]},"redactions":{"total":0,"items":0},"projection":{"basis":"projected","calls":4,"estimatedInputTokens":2144,"projectedUsd":0.000090048,"priceAsOf":"2026-09-19"},"dryRun":false,"source":"replay","counts":{"items":4,"kept":2,"keptTotal":2,"undecided":0,"dropped":2,"failed":0,"skipped":0},"usage":{"input_tokens":0,"output_tokens":0,"cost":0},"wallClockMs":27}
```
